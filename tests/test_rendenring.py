...
def test_render_templates_for_given_service_and_inventory(renderer, confgen):
    ...
    templates = renderer.render_templates_for_service('webapp', built_inventory['/prod/main/webapp1'].all_attrs)
    ...
    templates = renderer.render_templates_for_service('webapp', built_inventory['/dev/qa1'].all_attrs)
    ...
    templates = renderer.render_templates_for_service('api', built_inventory['/test'].all_attrs)
...
def test_render_templates_for_multiple_service_and_inventory(renderer, confgen):
    ...
    templates = renderer.render_templates_for_services(
        ['webapp', 'api'],
        built_inventory['/prod/main/webapp1'].all_attrs
    )
...
def test_render_template_with_undefined_key(renderer, confgen):
    ...
    built_inventory['/prod/main/webapp1'].all_attrs.pop('secret')  # remove required key to render
